-- Gold : comparaison inter-typologies de carte (axe "layout de départ", cf. GAME_DESIGN.md).
-- Une typologie = un scénario délibéré (aléatoire / chemin bloqué / pièce leurre),
-- indépendamment du modèle LLM utilisé.
select
    typology,
    count(*)                                                as n_runs,
